...
function Library:CreateWindow(WindowInfo)
    ...
    function Window:AddTab(...)
        ...
        function Tab:AddGroupbox(Info)
            ...
            local IsCollapsed = (Info.DefaultOpen == false)
            ...
            function Groupbox:SetCollapsed(State)
                ...
                GroupboxDivider.Visible = not State
                GroupboxArrow.Text = State and "▶" or "▼"
                Groupbox:Resize()
            end

            GroupboxHeader.MouseButton1Click:Connect(function()
